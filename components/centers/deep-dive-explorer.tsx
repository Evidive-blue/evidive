  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-950 via-blue-950 to-black">
      ...
      <div className="relative z-10 pt-20 pb-8 px-4">
        <div className="container-custom">
          ...
          >
            ...
            <div className="flex gap-2">
              <Button
                ...
                className={viewMode === 'globe' ? 'bg-cyan-400 text-black' : 'text-white/60'}
              >
              ...
              <Button
                ...
                className={viewMode === 'list' ? 'bg-cyan-400 text-black' : 'text-white/60'}
              >
          ...
          <motion.div
            ...
            className="flex justify-center gap-8 mt-6 text-sm text-white/40"
          >
      ...
      <div className="relative z-10 flex-1">
        {viewMode === 'globe' ? (
          <div className="flex flex-col lg:flex-row h-[calc(100vh-300px)] min-h-[500px]">
            {/* 3D Globe */}
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            <motion.div
              ...
              animate={{ opacity: 1, x: 0 }}
              transition={{ delay: 0.5 }}
              className="w-full lg:w-96 bg-black/40 backdrop-blur-xl border-l border-white/10 overflow-hidden flex flex-col"
            >
