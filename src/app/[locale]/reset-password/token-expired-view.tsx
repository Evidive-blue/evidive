  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden pb-16 pt-24">
      ...
      <div className="absolute inset-0 z-0">
        <motion.div
          className="absolute right-1/4 top-1/3 h-[400px] w-[400px] rounded-full bg-orange-500/15 blur-[120px]"
      ...
      >
        <div className="rounded-3xl border border-white/10 bg-white/5 p-8 text-center backdrop-blur-xl">
          <motion.div
            className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-full border-2 border-orange-500 bg-orange-500/20"
            initial={{ scale: 0 }}
            animate={{ scale: 1 }}
